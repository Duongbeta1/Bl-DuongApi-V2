if (game:GetService("CoreGui")):FindFirstChild("DuongApi") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).NoxHub:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(100, 100, 100);
_G.Dark = Color3.fromRGB(22, 22, 26);
_G.Third = Color3.fromRGB(135, 206, 250);
...
ImageButton.Image = "rbxassetid://107699233715655";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("DuongApi")).Enabled = not (game.CoreGui:FindFirstChild("DuongApi")).Enabled;
end);
...
function Update:StartLoad()
	...
	LoadingBar.BackgroundColor3 = Color3.fromRGB(135, 206, 250);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("DuongApi/Library/") then
			makefolder("DuongApi/Library/");
		end;
		if not isfile(("DuongApi/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("DuongApi/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("DuongApi/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("DuongApi/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("DuongApi/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	function CreateCheckbox(title, state, callback)
		...
		Checkbox.MouseButton1Click:Connect(function()
			...
			if checked then
				...
				Checkbox.BackgroundColor3 = Color3.fromRGB(135, 206, 250);
			else
				Checkbox.ImageTransparency = 1;
				Checkbox.BackgroundColor3 = Color3.fromRGB(100, 100, 100);
			end;
	...
	function uitab:Tab(text, img)
		...
		function main:Seperator(text)
			...
			Sep1.RichText = true;
			Sep1.Text = " 〈<font color=\"rgb(135, 206, 250)\"> 〈</font>";
			...
			Sep3.RichText = true;
			Sep3.Text = "<font color=\"rgb(135, 206, 250)\">〉</font>〉";
