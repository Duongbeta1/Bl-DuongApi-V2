print("✅ Security verification passed. Loading Dương Api...")
...
-- print("--------------------------------------------------------------------------");
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/Duongbeta1/Bl-DuongApi-V2/main/data/theme.lua")))();
